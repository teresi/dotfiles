...
return {
	...
	config = function()
		...
		-- NOTE: <leader>fb is format buffer for conform
		-- NOTE: <leader>s is a substitute call (where is this defined?)
		--
		...
		vim.keymap.set("n", "<leader>f.", builtin.oldfiles, { desc = '[F]findRecent Files ("." for repeat)' })
